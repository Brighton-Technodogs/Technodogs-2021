...
private NetworkTableEntry gshooterLS = subsystemShuffleboardTab.add("Graph Left Shooter Encoder", 0)
  ...
  public void shoot(double bottomSpeed, double rightSpeed, double leftSpeed) {
    ...
    shooterRV.setDouble(rightSpeed);
    shooterBV.setDouble(bottomSpeed);
    shooterLV.setDouble(leftSpeed);

    gshooterRV.setDouble(rightSpeed);
    gshooterBV.setDouble(bottomSpeed);
    gshooterLV.setDouble(leftSpeed);
  ...
  public void spinToSpeed(double spinSpeed) {
    ...
    shooterRV.setDouble(rightVelocity);
    shooterBV.setDouble(bottomVelocity);
    shooterLV.setDouble(leftVelocity);
